...
function usage(err) {
  ...
  console.log('Usage: grantAdmin <user>@<index>')
  console.log('Example: grantAdmin testuser@index.private.io')
  process.exit(10);
}
...
module.exports = function(dockercfg) {
  ...
  return {
    ...
    callback: function(options) {
      ...
      var url = util.format('%s://%s/users/%s/admin', protocol, index, username);
