...
function usage(err) {
  ...
  console.log('Usage: enableUser <user>@<index>')
  console.log('Example: enableUser testuser@index.private.io')
  process.exit(10);
}
...
module.exports = function(dockercfg) {
  ...
  return {
    ...
    callback: function(options) {
      ...
      var url = util.format('%s://%s/users/%s/enable', protocol, index, username);
      ...
      request.put(url_options, function(err, res, body) {
        if (err) {
